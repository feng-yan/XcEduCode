...
public class AuthService {
    ...
    public AuthToken login(String username, String password, String clientId, String clientSecret) {
        ...
        if (authToken == null) {
            ExceptionUtils.throwEx(AuthCode.AUTH_LOGIN_APPLYTOKEN_FAIL);
        }
        ...
        if (!result) {
            ExceptionUtils.throwEx(AuthCode.AUTH_LOGIN_TOKEN_SAVEFAIL);
        }
        ...
        if (bodyMap == null ||
            ...
            if (bodyMap != null && bodyMap.get("error_description") != null) {
                ...
                if (error_description.indexOf("UserDetailsService returned null") >= 0) {
                    ExceptionUtils.throwEx(AuthCode.AUTH_ACCOUNT_NOTEXISTS);
                } else if (error_description.indexOf("坏的凭证") >= 0) {
                    ExceptionUtils.throwEx(AuthCode.AUTH_CREDENTIAL_ERROR);
                }
            }
